...
2) **Direct download via the raw base64 file:** Once this branch is on GitHub, grab the zip in one step using the raw file URL (replace placeholders with your repo):
